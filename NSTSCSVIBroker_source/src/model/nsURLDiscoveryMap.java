...
public class nsURLDiscoveryMap {
	public int id;
	public nlAccount account;
	public nldataCenterURLs dataCenterURLs;
	public nlRole role;
	
	public nsURLDiscoveryMap(){
		this.account = new nlAccount();
		this.role = new nlRole();
		this.dataCenterURLs = new nldataCenterURLs();
	}
